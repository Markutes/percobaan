...
//			case "Email":		 this.email(); 			break;
			case "OldPassword":	 this.oldPassword(); 	break;
			case "Password":
			case "HL_Password":
			case "LP_Password":
				this.password();
				break;
			case "CPassword":	 this.cpassword(); 		break;
			case "FirstName":	 this.firstName(); 		break;
//			case "LastName":	 this.lastName(); 		break;
			case "MobileNumber": this.mobileNumber();	break;
			case "Referral":	 this.referral(); 		break;
...
//			this.message = validationMsg.valid_captcha;
	...
	setFocus() {
		...
		$('html, body').animate({scrollTop: element.offset().top - 60}, 0);
